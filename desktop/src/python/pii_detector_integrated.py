...
from italian_legal_context import is_allowed_entity, is_denied_pattern, get_all_allow_list_terms
from spacy_optimizer import SpaCyOptimizer
from entity_thresholds import EntityThresholdManager
from text_prefilter import TextPreFilter
